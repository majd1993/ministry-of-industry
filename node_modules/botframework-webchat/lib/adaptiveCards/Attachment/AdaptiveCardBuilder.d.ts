...
export default class AdaptiveCardBuilder {
    ...
    addColumnSet(sizes: number[], container?: Container, selectAction?: CardAction): Column[];
    ...
    addImage(url: string, container?: Container, selectAction?: CardAction, altText?: string): void;
}
